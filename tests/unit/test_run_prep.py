"""Tests for run_prep helpers (Plan 08 Phase 1).

Covers the three helper functions added to core/run_prep.py:
...
class TestResolveAgentPromptBindings:
    def test_no_bindings_returns_empty(self):
        from agentbox.core.run_prep import resolve_agent_prompt_bindings
...
class TestSnapshotHelpers:
    def test_workspace_outcomes_to_snapshot(self):
        ...
        from agentbox.core.run_prep import workspace_outcomes_to_snapshot
    ...
    def test_prompt_resolution_to_snapshot(self):
        from agentbox.core.resources.prompt_resolver import PromptResolution, ResolvedBinding
        from agentbox.core.run_prep import prompt_resolution_to_snapshot
