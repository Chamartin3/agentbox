...
class TestAgentLifecycle:
    ...
    def test_publish_rejects_short_reason(self, svc: AgentService) -> None:
        svc.create_agent(
    ...
    def test_publish_is_idempotent_for_already_active(self, svc: AgentService) -> None:
        svc.create_agent(
            agent_id="idempotent",
    ...
    def test_publish_raises_for_missing_version(self, svc: AgentService) -> None:
        svc.create_agent(
    ...
    def test_branch_draft_copies_config_and_files(self, svc: AgentService) -> None:
    ...
    def test_branch_draft_raises_without_active_version(self, svc: AgentService) -> None:
        svc.create_agent(
            agent_id="no-active",
    ...
    def test_branch_draft_does_not_change_active_pointer(self, svc: AgentService) -> None:
        svc.create_agent(
    ...
    def test_rollback_creates_new_version_and_activates_it(self, svc: AgentService) -> None:
        # Create v1, publish
        v1 = svc.create_agent(
    ...
    def test_rollback_copies_files_from_target(self, svc: AgentService) -> None:
        v1 = svc.create_agent(
    ...
    def test_rollback_rejects_short_reason(self, svc: AgentService) -> None:
        svc.create_agent(
    ...
    def test_rollback_raises_for_missing_target_version(self, svc: AgentService) -> None:
        svc.create_agent(
