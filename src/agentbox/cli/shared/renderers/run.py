...
class RunRenderer(Renderer):
    ...
    def runs_table(self, rows: Sequence[Mapping[str, JsonValue]]) -> None:
        ...
        for r in rows:
            ...
            usage: dict[str, JsonValue] = usage_raw if isinstance(usage_raw, dict) else {}
    ...
    def event_line(self, event_type: str, payload: dict[str, JsonValue]) -> None:
