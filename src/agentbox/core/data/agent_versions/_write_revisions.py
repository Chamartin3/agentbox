"""Draft/revision writes: branch_draft, save_prompt_revision, save_config_revision."""
...
from agentbox.core.data.agent_versions._models import _copy_version_files
from agentbox.core.data.records import now_iso
from agentbox.core.data.schema import active_agent_versions, agent_versions


class _AgentVersionsRevisionsMixin:
