...
class WorkspacesMixin:
    """
    .. deprecated::
        Use ``db.workspaces`` manager methods instead.
    ...
    def get_workspace(self, name: str) -> WorkspaceRow | None:
        warnings.warn(
            "WorkspacesMixin.get_workspace is deprecated; use db.workspaces manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        with self.engine.connect() as conn:
    ...
    def create_workspace(
        ...
        *,
        ...
        warnings.warn(
            "WorkspacesMixin.create_workspace is deprecated; use db.workspaces manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def upsert_workspace(
        ...
        *,
        ...
        warnings.warn(
            "WorkspacesMixin.upsert_workspace is deprecated; use db.workspaces manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        now = now_iso()
    ...
    def delete_workspace_cascade(self, name: str) -> dict:
        ...
        """
        warnings.warn(
            "WorkspacesMixin.delete_workspace_cascade is deprecated; use db.workspaces manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        counts: dict[str, int] = {}
    ...
    def backfill_workspaces_from_satellites(self) -> int:
        ...
        """
        warnings.warn(
            "WorkspacesMixin.backfill_workspaces_from_satellites is deprecated; use db.workspaces manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        now = now_iso()
    ...
    def prune_phantom_workspaces(self, keep: set[str]) -> list[str]:
        ...
        """
        warnings.warn(
            "WorkspacesMixin.prune_phantom_workspaces is deprecated; use db.workspaces manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        deleted: list[str] = []
