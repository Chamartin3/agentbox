"""Workspace-scoped MCP overrides.
...
class McpOverridesMixin:
    ...
    def set_workspace_mcp_policy(self, workspace_id: str, policy: str) -> McpPolicy:
        warnings.warn(
            "McpOverridesMixin.set_workspace_mcp_policy is deprecated; use db.workspace_mcp_overrides / db.workspace_mcp_tool_overrides manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def list_workspace_mcp_server_overrides(self, workspace_id: str) -> list[dict]:
        warnings.warn(
            "McpOverridesMixin.list_workspace_mcp_server_overrides is deprecated; use db.workspace_mcp_overrides / db.workspace_mcp_tool_overrides manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        with self.engine.connect() as conn:
    ...
    def set_workspace_mcp_server_override(
        ...
        *,
        ...
        warnings.warn(
            "McpOverridesMixin.set_workspace_mcp_server_override is deprecated; use db.workspace_mcp_overrides / db.workspace_mcp_tool_overrides manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def list_workspace_mcp_tool_overrides(self, workspace_id: str) -> list[dict]:
        warnings.warn(
            "McpOverridesMixin.list_workspace_mcp_tool_overrides is deprecated; use db.workspace_mcp_overrides / db.workspace_mcp_tool_overrides manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        with self.engine.connect() as conn:
    ...
    def set_workspace_mcp_tool_override(
        ...
        *,
        ...
        warnings.warn(
            "McpOverridesMixin.set_workspace_mcp_tool_override is deprecated; use db.workspace_mcp_overrides / db.workspace_mcp_tool_overrides manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        now = now_iso()
    ...
    def resolve_workspace_mcp(
        ...
        *,
        ...
        """
    .. deprecated::
        Use ``db.workspace_mcp_overrides / db.workspace_mcp_tool_overrides`` manager methods instead.
    ...
    Apply overrides to ``manifest_servers``.
        ...
        """
        warnings.warn(
            "McpOverridesMixin.resolve_workspace_mcp is deprecated; use db.workspace_mcp_overrides / db.workspace_mcp_tool_overrides manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
