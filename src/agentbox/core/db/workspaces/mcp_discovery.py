"""MCP tool discovery cache mixin.
...
class McpDiscoveryMixin:
    ...
    def get_cached_tools(
        ...
        *,
        ...
        """
    .. deprecated::
        Use ``db.mcp_tool_discovery_cache`` manager methods instead.
    ...
    Return the cached tool list, or *None* if absent / expired.
        ...
        """
        warnings.warn(
            "McpDiscoveryMixin.get_cached_tools is deprecated; use db.mcp_tool_discovery_cache manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def cache_tools(
        ...
        warnings.warn(
            "McpDiscoveryMixin.cache_tools is deprecated; use db.mcp_tool_discovery_cache manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def invalidate_server_cache(self, server_name: str) -> int:
        ...
        warnings.warn(
            "McpDiscoveryMixin.invalidate_server_cache is deprecated; use db.mcp_tool_discovery_cache manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        with self.engine.begin() as conn:
