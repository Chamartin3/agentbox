...
class WorkenvTemplatesMixin:
    ...
    def list_workenv_templates(self) -> list[dict]:
        warnings.warn(
            "WorkenvTemplatesMixin.list_workenv_templates is deprecated; use db.workenv_templates manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def get_workenv_template(self, name: str) -> dict | None:
        warnings.warn(
            "WorkenvTemplatesMixin.get_workenv_template is deprecated; use db.workenv_templates manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        with self.engine.connect() as conn:
    ...
    def upsert_workenv_template(
        ...
        *,
        ...
        warnings.warn(
            "WorkenvTemplatesMixin.upsert_workenv_template is deprecated; use db.workenv_templates manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        now = now_iso()
    ...
    def delete_workenv_template(self, name: str) -> bool:
        warnings.warn(
            "WorkenvTemplatesMixin.delete_workenv_template is deprecated; use db.workenv_templates manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        with self.engine.begin() as conn:
    ...
    def seed_workenv_templates(
        ...
        *clobber* is True.
        """
        warnings.warn(
            "WorkenvTemplatesMixin.seed_workenv_templates is deprecated; use db.workenv_templates manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        seeded = 0
