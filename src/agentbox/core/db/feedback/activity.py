...
from agentbox.core.db.schema import runs, usage
...
class ActivityAnalyticsMixin:
    ...
    def distinct_executors(self) -> list[str]:
        ...
        warnings.warn(
            "ActivityAnalyticsMixin.distinct_executors is deprecated; use db.usage (analytics) manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        stmt = (
    ...
    def activity_summary(
        ...
        warnings.warn(
            "ActivityAnalyticsMixin.activity_summary is deprecated; use db.usage (analytics) manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
