...
class ListingAnalyticsMixin:
    ...
    def list_runs_paged(
        ...
        *,
        ...
        """
        warnings.warn(
            "ListingAnalyticsMixin.list_runs_paged is deprecated; use db.runs (listing) manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def list_runs_rich(
        ...
        warnings.warn(
            "ListingAnalyticsMixin.list_runs_rich is deprecated; use db.runs (listing) manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        stmt = (
