...
class ProjectConfigMixin(SettingsMixin):
    ...
    def get_project_mcp_servers(self) -> list[McpServerSpec]:
        warnings.warn(
            "ProjectConfigMixin.get_project_mcp_servers is deprecated; use db.settings manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def delete_project_mcp_server(self, name: str) -> None:
        warnings.warn(
            "ProjectConfigMixin.delete_project_mcp_server is deprecated; use db.settings manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        from agentbox.core.db.schema import settings as settings_table  # noqa: PLC0415
    ...
    def delete_project_shared_asset(self, name: str) -> None:
        warnings.warn(
            "ProjectConfigMixin.delete_project_shared_asset is deprecated; use db.settings manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        from agentbox.core.db.schema import settings as settings_table  # noqa: PLC0415
    ...
    def get_backend_preference(self) -> list[str]:
        warnings.warn(
            "ProjectConfigMixin.get_backend_preference is deprecated; use db.settings manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def get_project_name(self) -> str:
        warnings.warn(
            "ProjectConfigMixin.get_project_name is deprecated; use db.settings manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
