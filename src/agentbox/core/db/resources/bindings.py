...
Both binding tables key off ``resources.id``; one mixin owns CRUD for
both because the editing UX is the same shape (replace the whole set
atomically with a reason).
...
from agentbox.core.db.row_types import RepoResourceRow
...
class ResourceBindingsMixin:
    """
    .. deprecated::
        Use ``db.agent_prompt_resource_bindings / db.workspace_file_resource_bindings`` manager methods instead.
    ...
    def list_prompt_bindings(self, agent_id: str) -> list[dict]:
        warnings.warn(
            "ResourceBindingsMixin.list_prompt_bindings is deprecated; use db.agent_prompt_resource_bindings / db.workspace_file_resource_bindings manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def replace_prompt_bindings(
        ...
        *,
        ...
        warnings.warn(
            "ResourceBindingsMixin.replace_prompt_bindings is deprecated; use db.agent_prompt_resource_bindings / db.workspace_file_resource_bindings manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def list_workspace_file_bindings(self, workspace_id: str) -> list[dict]:
        warnings.warn(
            "ResourceBindingsMixin.list_workspace_file_bindings is deprecated; use db.agent_prompt_resource_bindings / db.workspace_file_resource_bindings manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        with self.engine.connect() as conn:
    ...
    def count_workspace_file_bindings_by_workspace(self) -> dict[str, int]:
        ...
        warnings.warn(
            "ResourceBindingsMixin.count_workspace_file_bindings_by_workspace is deprecated; use db.agent_prompt_resource_bindings / db.workspace_file_resource_bindings manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        with self.engine.connect() as conn:
    ...
    def replace_workspace_file_bindings(
        ...
        *,
        ...
        warnings.warn(
            "ResourceBindingsMixin.replace_workspace_file_bindings is deprecated; use db.agent_prompt_resource_bindings / db.workspace_file_resource_bindings manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        reason = _validate_reason(reason)
    ...
    def replace_workspace_skill_bindings(
        ...
        *,
        ...
        """
        warnings.warn(
            "ResourceBindingsMixin.replace_workspace_skill_bindings is deprecated; use db.agent_prompt_resource_bindings / db.workspace_file_resource_bindings manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def list_workspace_subagents(self, workspace_id: str) -> list[dict]:
        warnings.warn(
            "ResourceBindingsMixin.list_workspace_subagents is deprecated; use db.agent_prompt_resource_bindings / db.workspace_file_resource_bindings manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        with self.engine.connect() as conn:
    ...
    def replace_workspace_subagents(
        ...
        *,
        ...
        warnings.warn(
            "ResourceBindingsMixin.replace_workspace_subagents is deprecated; use db.agent_prompt_resource_bindings / db.workspace_file_resource_bindings manager instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        now = now_iso()
