...
def import_upload_version(resource_id: str, *, filename: str, content: bytes, mime_type: str | None, changelog: str, draft: bool = False, actor: str | None = None) -> ResourceVersionRow:
...
def import_host_path_version(resource_id: str, *, path: str, include: list[str], exclude: list[str], changelog: str, draft: bool = False, actor: str | None = None) -> ResourceVersionRow:
...
def import_zip_version(resource_id: str, *, filename: str, content: bytes, changelog: str, draft: bool = False, actor: str | None = None) -> ResourceVersionRow:
...
def import_schema_version(resource_id: str, *, filename: str, content: bytes, changelog: str, draft: bool = False, actor: str | None = None) -> ResourceVersionRow:
...
def import_script_version(resource_id: str, *, filename: str, content: bytes, changelog: str, language: str | None = None, input_schema_resource_id: str | None = None, output_schema_resource_id: str | None = None, draft: bool = False, actor: str | None = None) -> ResourceVersionRow:
